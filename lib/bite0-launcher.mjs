...
//
// Every side effect (start/launch/deliver/terminate/meter/timers/report) is injected, so the whole
// state machine is unit-testable with no real processes, network, or wall-clock.
